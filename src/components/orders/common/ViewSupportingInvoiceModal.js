...
class ViewSupportingInvoiceModal extends Component {
    ...
    render() {
        ...
        console.log( this.state.invoiceUrlData )
        return (<div>
            <Dialog style={{ zIndex: '9999' }}
                ...
                <DialogContent>
                    ...
                    {this.state.invoiceUrlData && this.state.invoiceUrlData.length === 0 &&
                    <NoDataAvailable style={{ color: "#fff", background: '#533381 !important' }} bvText={"No supporting images available"} />
                    }
                </DialogContent>
            </Dialog>
        </div>
...
ViewSupportingInvoiceModal.propTypes = {
    classes: PropTypes.object.isRequired,
};

export default withStyles(styles)(ViewSupportingInvoiceModal);