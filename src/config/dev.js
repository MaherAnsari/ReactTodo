...
const baseUrl = (hostName.indexOf('localhost') > -1 || hostName.indexOf('staging') > -1) ?
...
const baseUrl1 = (hostName.indexOf('localhost') > -1 || hostName.indexOf('staging') > -1) ?
...
const baseUrl3 = (hostName.indexOf('localhost') > -1 || hostName.indexOf('staging') > -1) ?
...
const baseUrl4 = (hostName.indexOf('localhost') > -1 || hostName.indexOf('staging') > -1) ?
